  	...
  	<div id="upload">메거진 수정</div>
			<form name="myForm" method="post" enctype="multipart/form-data">
				<table>
					...
					<tr><td>주제</td><td><input type="text"  id="topic" name="topic" class="inp" value="${vo.topic}"></td></tr>
					<tr><td>설명</td><td><textarea id="content" name="content" style="width:700px; height:200px;">${vo.content}</textarea></td></tr>
				</table>
					<input type="file" name="file" id="file" multiple="multiple" accept=".jpg,.png"><br/>
					<div>
						<div style="float:left">사진:</div> <div style="width:200px; height:100px;float:left;"><img src="${ctp}/magazine/${vo.FSName}" style="width:100%; height:100%; "></div>
					</div>
					<input type="button" value="수정하기" onclick="check()" id="magazineUpload"/>
